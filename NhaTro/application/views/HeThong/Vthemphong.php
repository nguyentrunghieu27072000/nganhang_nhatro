	   		...
	   		<form method="POST" id="frmSaveData" enctype="multipart/form-data">
	   			<div class="row">
					<div class="col-md-12">
					    ...
					    <div class="col-md-12">
					    	<div class="row">
					    		<div class="col-md-6">
					    			<div class="form-group">
					    				<label class="font-weight-bold">Địa chỉ(<span style="color:red">Nhập địa chỉ có trên bản đồ</span>)</label>
					    		...
					    		<div class="col-md-6">
					    			<div class="form-group">
					    				<label class="font-weight-bold">Địa chỉ chi tiết(<span style="color:red">Nếu có</span>)</label>
					...
					<div class="col-md-12">
						...
						<div class="col-md-8">
							<div class="form-group imgproduct" >
	                            <label>Chọn ảnh phòng trọ</label>
