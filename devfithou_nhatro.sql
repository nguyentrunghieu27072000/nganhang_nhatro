...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th6 08, 2020 lúc 09:31 AM
...
--
-- Cơ sở dữ liệu: `admin_doanthanhnien`
--
...
CREATE TABLE `dm_khoa` (
  ...
  `diachi_khoa` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=COMPACT;
...
INSERT INTO `dm_khoa` (`makhoa`, `tenkhoa`, `diachi_khoa`) VALUES
('1', 'Khoa Công nghệ Sinh học', '301 nguyễn trãi, thanh xuân, hà nội'),
('10', 'Khoa Tạo dáng Công nghiệp', '18 Tam trinh, Hoàng mai, hà nội'),
('11', 'Khoa Tiếng Anh', '301 nguyễn trãi, thanh xuân, hà nội'),
('12', 'Khoa Tiếng Trung Quốc', '193 Vĩnh Hưng, Hoàng Mai, Hà Nội'),
('2', 'Khoa CN Điện tử - Thông tin', '62 Phan đình giót, thanh xuân, hà nội'),
('3', 'Khoa Công nghệ Thông tin', '96 Định công, Thanh Xuân, Hà Nội'),
('4', 'Khoa Du lịch', '301 nguyễn trãi, thanh xuân, hà nội'),
('5', 'Khoa Luật', '193 Vĩnh Hưng, Hoàng Mai, Hà Nội'),
('7', 'Khoa Kinh tế', '193 Vĩnh Hưng, Hoàng Mai, Hà Nội'),
('8', 'Khoa Kiến trúc', 'Khu công nghiệp ngọc hồi, thanh trì, hà nội'),
('9', 'Khoa Tài chính Ngân hàng', 'Khu công nghiệp ngọc hồi, thanh trì, hà nội');
...
--
-- Cấu trúc bảng cho bảng `tbl_giaphong`
--

CREATE TABLE `tbl_giaphong` (
  `id_giaphong` int(11) NOT NULL,
  `giatu` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `giaden` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `tbl_giaphong`
--

INSERT INTO `tbl_giaphong` (`id_giaphong`, `giatu`, `giaden`) VALUES
(1, '500000', '1000000'),
(2, '1000000', '1500000'),
(3, '1500000', '2000000'),
(4, '2000000', '2500000'),
...
CREATE TABLE `tbl_hinhanh` (
  `id_anh` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `link_anh` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ghichu` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ma_nhatro` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tbl_hinhanh` (`id_anh`, `link_anh`, `ghichu`, `ma_nhatro`) VALUES
('fanjack261159114981315912655109616324', 'public/images/anhphongtro/AnhPhongTro-fanjackfanjack2611591149813/avata-fanjack26115911498131591265434.jpg', 'avata', 'fanjack26115911498131591265434'),
('fanjack261159114981315912656286874748', 'public/images/anhphongtro/AnhPhongTro-fanjackfanjack2611591149813/avata-fanjack26115911498131591265628.jpg', 'avata', 'fanjack26115911498131591265628'),
('LMnhHng664159126709715914118964475774', 'public/images/anhphongtro/AnhPhongTro-LêMạnhHùngLMnhHng6641591267097/avata-LMnhHng66415912670971591348265.jpg', 'avata', 'LMnhHng66415912670971591348265'),
('NguynVnLm258159073086415911131023201588', 'public/images/anhphongtro/AnhPhongTro-NguyễnVănLâmNguynVnLm2581590730864/avata-NguynVnLm25815907308641591113102.jpg', 'avata', 'NguynVnLm25815907308641591113102'),
('NguynVnLm258159073086415911131029449122', 'public/images/anhphongtro/AnhPhongTro-NguyễnVănLâmNguynVnLm2581590730864/anhnhatro-0-NguynVnLm25815907308641591113102.jpg', NULL, 'NguynVnLm25815907308641591113102'),
('NguynVnLm258159073086415911133274394530', 'public/images/anhphongtro/AnhPhongTro-NguyễnVănLâmNguynVnLm2581590730864/anhnhatro-0-NguynVnLm25815907308641591113326.jpg', NULL, 'NguynVnLm25815907308641591113326'),
('NguynVnLm258159073086415911133279916269', 'public/images/anhphongtro/AnhPhongTro-NguyễnVănLâmNguynVnLm2581590730864/avata-NguynVnLm25815907308641591113326.jpg', 'avata', 'NguynVnLm25815907308641591113326'),
('NguynVnLm258159073086415911133991764857', 'public/images/anhphongtro/AnhPhongTro-NguyễnVănLâmNguynVnLm2581590730864/avata-NguynVnLm25815907308641591113399.jpg', 'avata', 'NguynVnLm25815907308641591113399'),
('NguynVnLm258159073086415911133994424787', 'public/images/anhphongtro/AnhPhongTro-NguyễnVănLâmNguynVnLm2581590730864/anhnhatro-0-NguynVnLm25815907308641591113399.jpg', NULL, 'NguynVnLm25815907308641591113399'),
('NguynVnLm258159073086415911186593480765', 'public/images/anhphongtro/AnhPhongTro-NguyễnVănLâmNguynVnLm2581590730864/avata-NguynVnLm25815907308641591113022.jpg', 'avata', 'NguynVnLm25815907308641591113022'),
('NguynVnLm258159073086415911190656266582', 'public/images/anhphongtro/AnhPhongTro-NguyễnVănLâmNguynVnLm2581590730864/anhnhatro-10-NguynVnLm25815907308641591113022.jpg', NULL, 'NguynVnLm25815907308641591113022'),
('NguynVnLm258159073086415911190656613166', 'public/images/anhphongtro/AnhPhongTro-NguyễnVănLâmNguynVnLm2581590730864/anhnhatro-6-NguynVnLm25815907308641591113022.jpg', NULL, 'NguynVnLm25815907308641591113022'),
('NguynVnLm258159073086415911190656787270', 'public/images/anhphongtro/AnhPhongTro-NguyễnVănLâmNguynVnLm2581590730864/anhnhatro-7-NguynVnLm25815907308641591113022.jpg', NULL, 'NguynVnLm25815907308641591113022'),
('NguynVnLm25815907308641591119065974101', 'public/images/anhphongtro/AnhPhongTro-NguyễnVănLâmNguynVnLm2581590730864/anhnhatro-9-NguynVnLm25815907308641591113022.jpg', NULL, 'NguynVnLm25815907308641591113022'),
('ThuyLinh978159126397515912653207589863', 'public/images/anhphongtro/AnhPhongTro-ThuyLinhThuyLinh9781591263975/avata-ThuyLinh97815912639751591264100.jpg', 'avata', 'ThuyLinh97815912639751591264100');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `tbl_hoi`
--

CREATE TABLE `tbl_hoi` (
  `id_hoi` int(11) NOT NULL,
  `ma_user` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `noidung` text COLLATE utf8_unicode_ci NOT NULL,
  `ngayhoi` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `ma_nhatro` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `tbl_hoi`
--

INSERT INTO `tbl_hoi` (`id_hoi`, `ma_user`, `noidung`, `ngayhoi`, `ma_nhatro`) VALUES
(59, 'fanjack2611591149813', 'sadsad', '03/06/2020', 'NguynVnLm25815907308641591113022'),
(67, 'fanjack2611591149813', 'Đẹp lắm ạ', '04/06/2020 10:1', 'NguynVnLm25815907308641591113022'),
(80, 'NguynVnLm2581590730864', 'Nhà trọ', '05/06/2020 10:3', 'fanjack26115911498131591265434');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `tbl_loainhatro`
--

CREATE TABLE `tbl_loainhatro` (
  `id_loai` int(11) NOT NULL,
  `ten_loai_nhatro` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `tbl_loainhatro`
--

INSERT INTO `tbl_loainhatro` (`id_loai`, `ten_loai_nhatro`, `ghichu`, `stt`, `href`, `icon`) VALUES
(1, 'Nhà trọ & phòng trọ', '2', 2, 'PhongTro', 'fa fa-users'),
(2, 'Nhà nguyên căn', '2', 3, 'PhongTro', 'fa fa-blind'),
(6, 'Home', '1', 1, 'TrangChu', 'fa fa-home'),
(8, 'Nhà tập thể', '2', 5, 'PhongTro', 'fa fa-ils'),
(9, 'Tìm bạn ở ghép', '2', 6, 'PhongTro', 'fa fa-medium'),
(10, 'Kí túc xa', '2', 7, NULL, NULL),
(11, 'Chung cư mini', '2', 8, NULL, NULL);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `tbl_phongtro`
--

CREATE TABLE `tbl_phongtro` (
  `ma_nhatro` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `ten_nhatro` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ma_loai_nhatro` int(11) NOT NULL,
  `user_id` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `id_xa` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `diachi` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `mota_phong` text COLLATE utf8_unicode_ci,
  `dientich` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ngaydang` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
  `giaphong` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `id_trangthai` int(11) DEFAULT NULL,
  `diachi_chitiet` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `tbl_phongtro`
--

INSERT INTO `tbl_phongtro` (`ma_nhatro`, `ten_nhatro`, `ma_loai_nhatro`, `user_id`, `id_xa`, `diachi`, `mota_phong`, `dientich`, `ngaydang`, `giaphong`, `id_trangthai`, `diachi_chitiet`) VALUES
('fanjack26115911498131591265434', 'Nhà Định Công', 9, 'fanjack2611591149813', '00307', 'Phường Định Công, Quận Hoàng Mai, Hà Nội', '-định c&ocirc;ng', '22', '04/06/2020', '1,000,000', 1, ''),
('fanjack26115911498131591265628', 'Nhà Định Công', 2, 'fanjack2611591149813', '00307', 'Phường Định Công, Quận Hoàng Mai, Hà Nội', '', '25', '04/06/2020', '1,000,000', 2, ''),
('LMnhHng66415912670971591348265', 'Nhà trọ 30m2', 1, 'LMnhHng6641591267097', '00172', 'Phường Yên Hòa, Quận Cầu Giấy, Hà Nội', '', '30', '06/06/2020', '3,000,000', 1, ''),
('NguynVnLm25815907308641591113022', 'Phòng trọ 8B-24-162 Đội Cấn 22m²', 2, 'NguynVnLm2581590730864', '00022', 'Phường Đội Cấn, Quận Ba Đình, Hà Nội', 'Cho Sinh Vi&ecirc;n, người đi l&agrave;m thu&ecirc; ph&ograve;ng Tầng 4, diện t&iacute;ch 22m2 tại số 8B/24/162 Đội Cấn, c&oacute; đầy đủ C&aacute;p, Internet, c&oacute; điều h&ograve;a, chỗ để xe, An Ninh tốt, giờ giấc thoải m&aacute;i. LH: C&ocirc; Trang<br />\r\nNhấn để hiện số:&nbsp;094300 ***', '100', '03/06/2020', '1,250,000', 1, 'Phường Đội Cấn, Quận Ba Đình, Hà Nội'),
('NguynVnLm25815907308641591113102', 'Cho thuê phòng ngõ 264 phố âu cơ', 1, 'NguynVnLm2581590730864', '00307', '96 Định Công, Quận Hoàng Mai, Hà Nội', 'Cho thu&ecirc; ph&ograve;ng (như h&igrave;nh) nh&agrave; số 1 ng&otilde; 264/17 phố &Acirc;u Cơ. Ph&ograve;ng đầy đủ tiện nghi: tivi, điều ho&agrave;, n&oacute;ng lạnh...c&oacute; cầu thang m&aacute;y tiện &iacute;ch (h&igrave;nh thức như chung cư mini), ch&igrave;a kho&aacute; tự quản. Khu bếp v&agrave; để xe ri&ecirc;ng biệt. Cho người đi l&agrave;m thu&ecirc; l&acirc;u d&agrave;i. ở tối đa 2 người', '35', '02/06/2020', '1,500,000', 2, '96 Định Công, Quận Hoàng Mai, Hà Nội'),
('NguynVnLm25815907308641591113326', 'P.Trọ Nguyễn Văn Trỗi full nội thất,giờ giấc tự do', 1, 'NguynVnLm2581590730864', '00358', 'Nguyễn Văn Trỗi, Phường Phương Liệt, Quận Thanh Xuân, Hà Nội', '+ CH&Iacute;NH CHỦ cho thu&ecirc; nh&agrave; đường Nguyễn Văn Trỗi gần đường L&ecirc; Trọng Tấn, Giải Ph&oacute;ng...<br />\r\n+ Nội thất: Giường đệm, tủ quần &aacute;o, b&agrave;n tr&agrave;, kệ s&aacute;ch, điều h&ograve;a, n&oacute;ng lạnh, m&aacute;y giặt, wifi...<br />\r\n+ Giờ giấc tự do, để xe tầng 1, an ninh tốt, camera 24/24.<br />\r\n+ Gi&aacute; ph&ograve;ng 2tr3 hợp đồng l&acirc;u d&agrave;i c&ograve;n 2tr2.<br />\r\n+ LH: Mr Hưng (chủ nh&agrave;) để xem ph&ograve;ng.', '20', '02/06/2020', '2,300,000', 1, 'Nguyễn Văn Trỗi, Phường Phương Liệt, Quận Thanh Xuân, Hà Nội'),
('NguynVnLm25815907308641591113399', 'KTX A5 pháp vân', 8, 'NguynVnLm2581590730864', '00337', 'Phường Hoàng Liệt, Quận Hoàng Mai, Hà Nội', 'M&igrave;nh sắp chuyển đi n&ecirc;n muốn cho thu&ecirc; lại ph&ograve;ng ở ng&otilde; 110 Trần Duy Hưng, gần chợ Trung K&iacute;nh.<br />\r\n<br />\r\nPh&ograve;ng tầng 6 trong nh&agrave; 7 tầng, kh&eacute;p k&iacute;n, để xe tầng 1 miễn ph&iacute;. Kh&ocirc;ng chung chủ, giờ giấc thoải m&aacute;i, nh&agrave; c&oacute; kh&oacute;a v&acirc;n tay, camera an ninh.<br />\r\n<br />\r\nPh&ograve;ng to rộng, tường mới tinh, kh&ocirc;ng bong tr&oacute;c g&igrave; (do bọn m&igrave;nh nhiều đồ n&ecirc;n ảnh ko r&otilde;, chứ ph&ograve;ng to lắm).<br />\r\n<br />\r\nĐ&atilde; c&oacute; sẵn giường, tủ quần &aacute;o to, n&oacute;ng lạnh, kệ bếp. Đặc biệt l&agrave; c&oacute; ĐIỀU H&Ograve;A chạy v&ugrave; v&ugrave; m&aacute;t rượi ❄️❄️❄️<br />\r\n<br />\r\nQuần &aacute;o c&oacute; thể phơi ở tầng 7 hoặc ban c&ocirc;ng.<br />\r\n<br />\r\n⭐ Gi&aacute; ph&ograve;ng 3.7tr. Cọc 1 th&aacute;ng, đ&oacute;ng tiền nh&agrave; theo th&aacute;ng. C&oacute; thể ở 3-4 người.<br />\r\nĐiện 4k/số<br />\r\nNước 100k/người<br />\r\nMạng 85k/ph&ograve;ng', '50', '02/06/2020', '410,000', 2, 'Phường Hoàng Liệt, Quận Hoàng Mai, Hà Nội'),
('ThuyLinh97815912639751591264100', 'sfkdkgr', 8, 'ThuyLinh9781591263975', '00106', 'Phường Yên Phụ, Quận Tây Hồ, Hà Nội', 'gdgrrhtrhr', '40', '04/06/2020', '4,000,000', 1, '57 An Dương');
...
--
-- Cấu trúc bảng cho bảng `tbl_tiennghi`
--

CREATE TABLE `tbl_tiennghi` (
  `id_tiennghi` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `ten_tiennghi` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `link_anh` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `tbl_tiennghi`
--

INSERT INTO `tbl_tiennghi` (`id_tiennghi`, `ten_tiennghi`, `link_anh`) VALUES
('1', 'Giường ngủ', 'bed.png'),
('10', ' Rèm cửa', 'stage.png'),
('11', ' Bình nóng lạnh', 'heater.png'),
('12', 'Máy giặt', 'washing-machine.png'),
('13', 'Giờ giấc tự do', '24-hours.png'),
('14', 'Ti vi', 'monitor.png'),
('15', 'Khóa vân tay', 'fingerprint.png'),
('16', 'Không chung chủ', 'leadership.png'),
('17', 'Camera', 'cctv.png'),
('18', 'Đệm giường', 'blanket.png'),
('19', 'Khu để xe', 'parking-sign.png'),
('2', 'Tủ đồ', 'wardrobe.png'),
('20', 'Thang máy', 'elevator.png'),
('3', ' Điều hòa', 'air-conditioner.png'),
('4', 'Bàn ghế', 'chair.png'),
('5', 'Ban công', 'balcony.png'),
('6', 'Thiết bị vệ sinh', 'shower.png'),
('7', 'Bàn bếp', 'teppanyaki.png'),
('8', ' Quạt điện', 'fan.png'),
('9', 'Tủ bếp', 'kitchen.png');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `tbl_tiennghi_nhatro`
--

CREATE TABLE `tbl_tiennghi_nhatro` (
  `id_tiennghi` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `id_nhatro` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `tbl_tiennghi_nhatro`
--

INSERT INTO `tbl_tiennghi_nhatro` (`id_tiennghi`, `id_nhatro`) VALUES
('1', 'fanjack26115911498131591265434'),
('1', 'fanjack26115911498131591265628'),
('1', 'LMnhHng66415912670971591348265'),
('1', 'NguynVnLm25815907308641591113022'),
('1', 'NguynVnLm25815907308641591113102'),
('1', 'NguynVnLm25815907308641591113326'),
('1', 'NguynVnLm25815907308641591113399'),
('1', 'ThuyLinh97815912639751591264100'),
('10', 'fanjack26115911498131591265434'),
('10', 'NguynVnLm25815907308641591113022'),
('10', 'NguynVnLm25815907308641591113102'),
('10', 'NguynVnLm25815907308641591113326'),
('10', 'ThuyLinh97815912639751591264100'),
('11', 'NguynVnLm25815907308641591113022'),
('11', 'NguynVnLm25815907308641591113102'),
('11', 'ThuyLinh97815912639751591264100'),
('12', 'NguynVnLm25815907308641591113022'),
('12', 'ThuyLinh97815912639751591264100'),
('13', 'fanjack26115911498131591265434'),
('13', 'fanjack26115911498131591265628'),
('13', 'NguynVnLm25815907308641591113022'),
('13', 'NguynVnLm25815907308641591113102'),
('13', 'NguynVnLm25815907308641591113326'),
('13', 'NguynVnLm25815907308641591113399'),
('13', 'ThuyLinh97815912639751591264100'),
('14', 'fanjack26115911498131591265434'),
('14', 'LMnhHng66415912670971591348265'),
('14', 'NguynVnLm25815907308641591113022'),
('14', 'NguynVnLm25815907308641591113102'),
('14', 'ThuyLinh97815912639751591264100'),
('15', 'NguynVnLm25815907308641591113022'),
('16', 'NguynVnLm25815907308641591113022'),
('16', 'ThuyLinh97815912639751591264100'),
('17', 'fanjack26115911498131591265628'),
('17', 'NguynVnLm25815907308641591113022'),
('17', 'NguynVnLm25815907308641591113326'),
('17', 'NguynVnLm25815907308641591113399'),
('18', 'LMnhHng66415912670971591348265'),
('18', 'NguynVnLm25815907308641591113022'),
('18', 'NguynVnLm25815907308641591113102'),
('18', 'NguynVnLm25815907308641591113326'),
('18', 'ThuyLinh97815912639751591264100'),
('19', 'NguynVnLm25815907308641591113022'),
('19', 'ThuyLinh97815912639751591264100'),
('2', 'NguynVnLm25815907308641591113022'),
('2', 'ThuyLinh97815912639751591264100'),
('20', 'LMnhHng66415912670971591348265'),
('20', 'NguynVnLm25815907308641591113022'),
('20', 'NguynVnLm25815907308641591113326'),
('20', 'NguynVnLm25815907308641591113399'),
('3', 'NguynVnLm25815907308641591113022'),
('3', 'NguynVnLm25815907308641591113102'),
('3', 'NguynVnLm25815907308641591113326'),
('3', 'ThuyLinh97815912639751591264100'),
('4', 'NguynVnLm25815907308641591113022'),
('4', 'ThuyLinh97815912639751591264100'),
('5', 'NguynVnLm25815907308641591113022'),
('6', 'NguynVnLm25815907308641591113022'),
('6', 'NguynVnLm25815907308641591113326'),
('6', 'NguynVnLm25815907308641591113399'),
('6', 'ThuyLinh97815912639751591264100'),
('7', 'NguynVnLm25815907308641591113022'),
('7', 'NguynVnLm25815907308641591113326'),
('7', 'ThuyLinh97815912639751591264100'),
('8', 'NguynVnLm25815907308641591113022'),
('8', 'ThuyLinh97815912639751591264100'),
('9', 'NguynVnLm25815907308641591113022'),
('9', 'NguynVnLm25815907308641591113102'),
('9', 'ThuyLinh97815912639751591264100');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `tbl_traloi`
--
...
CREATE TABLE `tbl_traloi` (
  ...
  `id_hoi` int(11) NOT NULL,
  `noidung` text COLLATE utf8_unicode_ci NOT NULL,
  `ngay_traloi` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `ma_user` varchar(255) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `tbl_traloi`
--

INSERT INTO `tbl_traloi` (`id_traloi`, `id_hoi`, `noidung`, `ngay_traloi`, `ma_user`) VALUES
(59, 67, 'Oke', '04/06/2020 10:1', 'fanjack2611591149813'),
(60, 67, 'Mọi thông tin trên website chỉ mang tính chất tham khảo. Chúng tôi luôn cố gắng cung cấp các thông tin đầy đủ, chính xác và minh bạch đến người xem, tuy nhiên quá trình kiểm duyệt vẫn có thể xảy ra sơ sót. Nếu bạn có phản hồi với tin đăng này (tin đã cho thuê, không liên lạc được, các trường hợp khác), vui lòng thông báo để hệ thống có thể xử lý.', '04/06/2020 10:1', 'fanjack2611591149813'),
(61, 67, 'Mọi thông tin trên website chỉ mang tính chất tham khảo. Chúng tôi luôn cố gắng cung cấp các thông tin đầy đủ, chính xác và minh bạch đến người xem, tuy nhiên quá trình kiểm duyệt vẫn có thể xảy ra sơ sót. Nếu bạn có phản hồi với tin đăng này (tin đã cho thuê, không liên lạc được, các trường hợp khác), vui lòng thông báo để hệ thống có thể xử lý.', '04/06/2020 10:1', 'fanjack2611591149813'),
(64, 59, 'Mọi thông tin trên website chỉ mang tính chất tham khảo. Chúng tôi luôn cố gắng cung cấp các thông tin đầy đủ, chính xác và minh bạch đến người xem, tuy nhiên quá trình kiểm duyệt vẫn có thể xảy ra sơ sót. Nếu bạn có phản hồi với tin đăng này (tin đã cho thuê, không liên lạc được, các trường hợp khác), vui lòng thông báo để hệ thống có thể xử lý.', '04/06/2020 10:1', 'fanjack2611591149813'),
(70, 80, 'Ok', '05/06/2020 10:3', 'NguynVnLm2581590730864');
...
CREATE TABLE `tbl_trangthai` (
  `id-trangthai` int(11) NOT NULL,
  `ten_trangthai` varchar(25) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `tbl_trangthai` (`id-trangthai`, `ten_trangthai`) VALUES
(1, 'Còn Phòng'),
(2, 'Hết phòng');
...
INSERT INTO `tbl_user` (`ma_user`, `hoten`, `sdt`, `maquyen`, `matkhau`) VALUES
('5831591577846', NULL, NULL, 1, 'da39a3ee5e6b4b0d3255bfef95601890afd80709'),
('admin', 'Admin', 'admin', 2, '40bd001563085fc35165329ea1ff5c5ecbdbbeef'),
('fanjack2611591149813', 'fan jack', '0394684487', 1, '356a192b7913b04c54574d18c28d46e6395428ab'),
('fanjack91591158840', 'fan jack', '0398169242', 1, '356a192b7913b04c54574d18c28d46e6395428ab'),
('LMnhHng6641591267097', 'Lê Mạnh Hùng', '0989874909', 1, '7c222fb2927d828af22f592134e8932480637c0d'),
('NgcAnh2771591265883', 'Đỗ Ngọc Anh', '0984688829', 1, 'a0d0697af2e8fd1bb5bd6e3db26d4335d721ac3e'),
('NguynLm2211590804960', 'Nguyễn Lâm', '01234567890', 1, '40bd001563085fc35165329ea1ff5c5ecbdbbeef'),
('NguynVnLm2581590730864', 'Nguyễn Văn Lâm', '0868378653', 1, '40bd001563085fc35165329ea1ff5c5ecbdbbeef'),
('PhmThNgon6011591236280', 'Phạm Thị Ngoãn', '0339845495', 1, '7c4a8d09ca3762af61e59520943dc26494f8941b'),
('PhngLanAnh5371591380574', 'Phùng Lan Anh', '0386591760', 1, 'e31e74fb209f57895f447a53321814fb6a544c8f'),
('ThuyLinh9781591263975', 'ThuyLinh', '0932230884', 1, '3e25d51ae50d3b465f4684bb3ebc9fc452769665');
...
--
-- Chỉ mục cho bảng `tbl_giaphong`
--
ALTER TABLE `tbl_giaphong`
  ADD PRIMARY KEY (`id_giaphong`);

--
-- Chỉ mục cho bảng `tbl_hinhanh`
--
ALTER TABLE `tbl_hinhanh`
  ADD PRIMARY KEY (`id_anh`,`ma_nhatro`),
  ADD KEY `ma_nhatro` (`ma_nhatro`);

--
-- Chỉ mục cho bảng `tbl_hoi`
--
ALTER TABLE `tbl_hoi`
  ADD PRIMARY KEY (`id_hoi`),
  ADD KEY `ma_user` (`ma_user`),
  ADD KEY `tbl_hoi_ibfk_2` (`ma_nhatro`);

--
-- Chỉ mục cho bảng `tbl_loainhatro`
--
ALTER TABLE `tbl_loainhatro`
  ADD PRIMARY KEY (`id_loai`);

--
-- Chỉ mục cho bảng `tbl_phongtro`
--
ALTER TABLE `tbl_phongtro`
  ADD PRIMARY KEY (`ma_nhatro`),
  ADD KEY `ma_loai_nhatro` (`ma_loai_nhatro`),
...
--
-- Chỉ mục cho bảng `tbl_tiennghi`
--
ALTER TABLE `tbl_tiennghi`
  ADD PRIMARY KEY (`id_tiennghi`);

--
-- Chỉ mục cho bảng `tbl_tiennghi_nhatro`
--
ALTER TABLE `tbl_tiennghi_nhatro`
  ADD PRIMARY KEY (`id_tiennghi`,`id_nhatro`),
  ADD KEY `id_nhatro` (`id_nhatro`);

--
-- Chỉ mục cho bảng `tbl_traloi`
--
ALTER TABLE `tbl_traloi`
...
--
-- AUTO_INCREMENT cho bảng `tbl_giaphong`
--
ALTER TABLE `tbl_giaphong`
  MODIFY `id_giaphong` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT cho bảng `tbl_hoi`
--
ALTER TABLE `tbl_hoi`
  MODIFY `id_hoi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;

--
-- AUTO_INCREMENT cho bảng `tbl_loainhatro`
--
ALTER TABLE `tbl_loainhatro`
...
--
-- AUTO_INCREMENT cho bảng `tbl_traloi`
--
ALTER TABLE `tbl_traloi`
  MODIFY `id_traloi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;

--
-- AUTO_INCREMENT cho bảng `tbl_trangthai`
--
ALTER TABLE `tbl_trangthai`
  MODIFY `id-trangthai` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- Các ràng buộc cho bảng `dm_huyen`
--
ALTER TABLE `dm_huyen`
  ADD CONSTRAINT `dm_huyen_ibfk_1` FOREIGN KEY (`mahuyen`) REFERENCES `dm_xa` (`mahuyen`) ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_chucnang`
--
ALTER TABLE `tbl_chucnang`
  ADD CONSTRAINT `tbl_chucnang_ibfk_1` FOREIGN KEY (`maquyen`) REFERENCES `tbl_quyen` (`iMa_Quyen`) ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_hinhanh`
--
ALTER TABLE `tbl_hinhanh`
  ADD CONSTRAINT `tbl_hinhanh_ibfk_1` FOREIGN KEY (`ma_nhatro`) REFERENCES `tbl_phongtro` (`ma_nhatro`) ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_hoi`
--
ALTER TABLE `tbl_hoi`
  ADD CONSTRAINT `tbl_hoi_ibfk_1` FOREIGN KEY (`ma_user`) REFERENCES `tbl_user` (`ma_user`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_hoi_ibfk_2` FOREIGN KEY (`ma_nhatro`) REFERENCES `tbl_phongtro` (`ma_nhatro`) ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_phongtro`
--
ALTER TABLE `tbl_phongtro`
  ADD CONSTRAINT `tbl_phongtro_ibfk_4` FOREIGN KEY (`ma_loai_nhatro`) REFERENCES `tbl_loainhatro` (`id_loai`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_phongtro_ibfk_5` FOREIGN KEY (`id_trangthai`) REFERENCES `tbl_trangthai` (`id-trangthai`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_phongtro_ibfk_6` FOREIGN KEY (`id_xa`) REFERENCES `dm_xa` (`maxa`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_phongtro_ibfk_7` FOREIGN KEY (`user_id`) REFERENCES `tbl_user` (`ma_user`) ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_tiennghi_nhatro`
--
ALTER TABLE `tbl_tiennghi_nhatro`
  ADD CONSTRAINT `tbl_tiennghi_nhatro_ibfk_1` FOREIGN KEY (`id_nhatro`) REFERENCES `tbl_phongtro` (`ma_nhatro`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tbl_tiennghi_nhatro_ibfk_2` FOREIGN KEY (`id_tiennghi`) REFERENCES `tbl_tiennghi` (`id_tiennghi`) ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `tbl_user`
--
ALTER TABLE `tbl_user`
  ADD CONSTRAINT `tbl_user_ibfk_1` FOREIGN KEY (`maquyen`) REFERENCES `tbl_quyen` (`iMa_Quyen`) ON UPDATE CASCADE;
COMMIT;
