        ...
        <div class="thongtintk text-center">
            {if empty($session)}
            <button type="button" class="btn btn-primary btn-tk dangkytc"><i class="fa fa-hand-o-right" aria-hidden="true"></i>&nbsp;Bạn muốn cung cấp thông tin nhà trọ, ở ghép</button>
            {else}
                <a href="themphong" class="btn btn-primary btn-tk athemphong"><i class="fa fa-hand-o-right" aria-hidden="true"></i>&nbsp;Bạn muốn cung cấp thông tin nhà trọ, ở ghép</a>
            {/if}
                ...
                <form method="post">
                    <fieldset>
                                ...
                                <div class="col-md-6 col-xs-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="giaphong" name="gia">
                                            ...
                                            {if empty($val.giatu)}
                                                <option value="{$val.id_giaphong}"> Trên 5 triệu VNĐ</option>
                                            {else}
                                                <option value="{$val.id_giaphong}" {if !empty($search) && $search['gia'] == $val.id_giaphong}selected{/if}> {number_format($val.giatu,0, ',', ',')} VNĐ - {number_format($val.giaden,0, ',', ',')} VNĐ</option>
                                            {/if}
                                        {/foreach}
                                    </select>
                                </div>
                        ...
                        <div class="col-md-12 text-center">
                               <button type="submit" name="timkiem" value="1" class="btn btn-warning" style="background: #707cd2; border-color: #707cd2; "><i class="fa fa-search"> </i>&nbsp;Tìm kiếm</button>
                        </div>
              <!--   <div class="col-md-3">
                    <div class="form-group">
                        <select class="form-control">
...
<div class="container-fluid timtrokhoa">
    <h3 class="h3-kn"><i class="fa fa-map-marker" aria-hidden="true"></i>&nbsp; Tìm nhà trọ gần khu giảng đường</h3>
