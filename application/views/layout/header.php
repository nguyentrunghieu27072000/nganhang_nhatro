...
<head>
   <meta charset="utf-8">
    ...
    <title>Hệ thông ngân hàng nhà trọ hỗ trợ sinh viên - Trường Đại học Mở Hà Nội </title>
    <base href="{base_url()}"> 
...
<body>
    <div id="header" class="animated fadeInDown slow">
        <div class="col-md-7">
            <h3 class="title-h">
                 Hệ thông ngân hàng nhà trọ hỗ trợ sinh viên <span class="hidden-sm hidden-xs">-</span><span class="hidden-lg hidden-md"><br></span> TRƯỜNG ĐẠI HỌC MỞ HÀ NỘI
            </h3>
        </div>
        {if !empty($session)}
            <div class="col-md-3 main-dangnhap">
                ...
                <div class="col-md-8 col-xs-5" style="font-weight: bold; padding-top: 10px;">
                    ...
                    {if !empty($session) && $session['maquyen'] == 1}
                        <div><a href="ds_phong">Quản lý tin nhà trọ</a></div>
                    {/if}
                </div>
